...
**	purpose:	
*********************************************************************/
#ifndef __ParticlePreviewActionItem_h__
#define __ParticlePreviewActionItem_h__

#include "MaxGUPCommon.h"
#include "IMaxExporter.h"

class ParticlePreviewActionItem : public ActionItem
{
public:
...
#endif // __ParticlePreviewActionItem_h__
