...
//# pragma pack(pop)
	...
	template<>
	Quaternion sKeyFrames<Quaternion>::interpolateHermite(float r,sKeyFrame<Quaternion> *pKeyFrame1,sKeyFrame<Quaternion> *pKeyFrame2)
	{
		//Quaternion t = rkt::interpolateHermite<Quaternion>(r,pKeyFrame1->v,pKeyFrame1->in,pKeyFrame2->v,pKeyFrame2->out);
		Quaternion t = InterpolateHermite<Quaternion>(r,pKeyFrame1->v,pKeyFrame1->v,pKeyFrame2->v,pKeyFrame2->v);
		return t;
	}

	template<>
	Quaternion sKeyFrames<Quaternion>::interpolateBezier(float r,sKeyFrame<Quaternion> *pKeyFrame1,sKeyFrame<Quaternion> *pKeyFrame2)
	{
		//Quaternion t = rkt::interpolateBezier<Quaternion>(r,pKeyFrame1->v,pKeyFrame1->in,pKeyFrame2->v,pKeyFrame2->out);
		Quaternion t = InterpolateBezier<Quaternion>(r,pKeyFrame1->v,pKeyFrame1->v,pKeyFrame2->v,pKeyFrame2->v);
		return t;
	}
}
