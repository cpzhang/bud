...
void Canvas::_renderGeometry()
{
	...
	if (_font[Euclid::eFontProperty_Normal])
	{
		...
		//_font[Euclid::eFontProperty_BG_1]->render(Vec3(10, 10, 0), Vec3(1, 0, 0), Euclid::Color(0.2f, 0.2f ,1.f ,1.f), ss.str());
		_font[Euclid::eFontProperty_Offset_1]->render(Vec3(10, 10, 0), Vec3(1, 0, 0), Euclid::Color::White, ss.str());
	}
