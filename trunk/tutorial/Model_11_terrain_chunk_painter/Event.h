...
class EventArgsSculptorRadiusChanged: public EventArgs
{
public:
	EventArgsSculptorRadiusChanged()
	{
		mRadius = 0.0f;
	}
public:
...
class EventArgsSculptorStrengthChanged: public EventArgs
{
public:
	EventArgsSculptorStrengthChanged()
	{
		mStrength = 0.0f;
	}
public:
