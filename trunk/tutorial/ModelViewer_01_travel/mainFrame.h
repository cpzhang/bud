...
private:
	...
	CSplitterWindow m_vSplitPropertySheet;
	CPaneContainer m_rPane;
	CPaneContainer m_lPane;
	CTreeViewCtrlEx m_tvCtrl;
	CHorSplitterWindow m_hSplit;
	CHorSplitterWindow m_hSplitAniSpeed;
	CPaneContainer m_uPane;
	CPaneContainer m_dPane;
	CComboBox m_animationBox;
	CTrackBarCtrl m_speedBar;
	CAnimationDlg m_aniDlg;
	CInformationDlg mInfomationDlg;
	//CPropertySheet mProSheet;
	//CPropertyPage<IDD_PROPPAGE_Information> mProPageInformation;
};
