...
#define FMOD_VERSION    0x00040713
...
{                       
    ...
    int     max3DReverbDSPs;    /* [in/out] The max number of 3d reverb DSP's in the system */
    int     minHRTFAngle;       /* [in/out] The angle (0-360) of a 3D sound from the listener's forward vector at which the HRTF function begins to have an effect */
    int     maxHRTFAngle;       /* [in/out] The angle (0-360) of a 3D sound from the listener's forward vector at which the HRTF function begins to have maximum effect */
    int     minHRTFFreq;        /* [in/out] The minimum corner frequency of the HRTF's LPF function */
    int     maxHRTFFreq;        /* [in/out] The maximum corner frequency of the HRTF's LPF function */
...
FMOD_RESULT F_API FMOD_SoundGroup_GetNumAudible      (FMOD_SOUNDGROUP *soundgroup, int *numaudible);
