                         ...
                         float2 vTexCoord0 : TEXCOORD0 )
{
    ...
    // vAnimatedPos.x *= (1.0 + cos(g_fTime)/10)*100;
    // vAnimatedPos.y *= (1.0 + sin(g_fTime)/10)*100;
    ...
    Output.Diffuse.rgb = g_MaterialDiffuseColor * g_LightDiffuse *  (1.5 + sin(g_fTime));// * max(0,dot(vNormalWorldSpace, g_LightDir))
